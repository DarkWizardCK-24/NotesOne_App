...
import 'package:notes_app/screens/view_screen.dart';
      ...
      body: GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () async {
                await Navigator.push(context, MaterialPageRoute(builder: (context) => ViewScreen(note: note)));
                _loadNotes();
              },
              child: Container(
